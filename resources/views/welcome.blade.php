...
<body>
    ...
    <section class="bg-dark text-white py-5">
        <div class="container text-center">
            ...
            <a href="#contact" class="btn btn-light btn-lg mb-3">Contact Us</a>
        </div>
        <div class="footer d-flex justify-content-between px-3 mt-5">
            <p class="footer-copyright text-center">&copy; 2024 IoT Palang Bandara 3D | All rights reserved</p>
            <div>
